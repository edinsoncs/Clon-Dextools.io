        ...
        <>
                    <div className="board-col col2 pancakeswap ample">
                        <div className="board-block hot-pairs">
                            <div className="col-title"><span className="icon icon-home-pancakeswap"><img src="images/ample.png" alt="" /></span> AMPLESWAP <strong>NEW PAIRS</strong><img className="line" src="images/line.svg" /></div>
                            <div className="col-content">

                            {data.map(function(object, i){
                                return <div className="pair-item">
                                    <a className="left" href={`/bsc/ample/pair-explorer/${object.id}`}>
