...
const api_service_save = 'https://api.metadex.tools/board/get/post';
const api_service_comment_save = 'https://api.metadex.tools/board/new/comment/save';
...
function Timeline(){
    ...
    React.useEffect(() => {
        if(hastag){
            let api_get_hastag = 'https://api.metadex.tools/board/get/'+ hastag +'/post';
            ...
            if(id){
                const api_service_get_id = 'https://api.metadex.tools/board/id/'+id+'/post';
                axios.get(api_service_get_id).then((response) => {
                    setPost(response.data.data);
                });

                const api_service_get_comments_id = 'https://api.metadex.tools/board/comments/'+id+'/post';
